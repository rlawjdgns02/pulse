...
# 특성 목록
features_right_cols = ['Systemic Vascular Resistance Index_Right', 'H4_Right', 'Systolic Blood Pressure_Right', 
                       'W_Area_R_Right', 'ECO(%)_Right', 'stdRespi_Right', 'Wfb_ratio_R_Right', 'Gradient_D1_Right', 
                       'MeanResp_Right', 'Cardiac Output_Right']

features_left_cols = ['H4_left', 'ECO(%)_Left', 'Cardiac Output_left', 'Ap_left', 'H2_f_R_Left', 'STD_PR_R_Left', 'Pulse Rate_left', 'Var_period_Left']
